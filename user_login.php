...
//echo "Connected successfully";
  ...
  if($email != "" && $pass != "" ){
    $sql1=mysqli_query($conn,"SELECT email,password FROM user_register WHERE email='$email'");
	...
	$sql3 =  mysqli_query($conn,"SELECT id FROM user_register WHERE email='$email'"); 
...
<div class="center">
<div class="b">
<img src="login.jpg" width="400" height="250"><br><br>
