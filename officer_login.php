...
//echo "Connected successfully";
  ...
  if($email != "" && $pass != "" ){
    $sql1=mysqli_query($conn,"SELECT email,password FROM officer_register WHERE email='$email'");
    //$sql2=mysqli_query($conn,"SELECT password FROM user_register WHERE password='$pass'");
	$sql11 = '';
    $sql22 = '';
...
<div class="center">
<div class="b">
<img src="officer.jpg" width="350" height="250"><br><br>
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <br><br>
    Password: 
    <input type="password" id ="password" class="input1" name="password" placeholder="Enter The Password">
