...
//echo "Connected successfully";
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      echo "<b><font color='red' size='5px'><b>User ID : " . $row["id"]."</b></font><br><br>". "<font color='white' size='5px'>Name : " . $row["name"]. " <br><br>" ."Email : ". $row["email"]. "<br><br>"."Mobile : ".$row["mobile"]. "<br><br>" ."Address : ".$row["address"]. "<br><br></font></b>";
    }
  } else {
    echo "0 results";
  }
